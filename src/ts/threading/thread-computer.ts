...
class ThreadComputer {
    ...
    public get instructions(): string {
        ...
        instructions.push("Here are instructions to reproduce this in real life. For better result, make sure you used the website at the highest quality mode and the highest thread opacity.\n");
