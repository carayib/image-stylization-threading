...
function main() {
    ...
    function mainLoop() {
        ...
        if (computedSomething && parameters_1.Parameters.showIndicators) {
...
var ThreadComputer = (function () {
    ...
    ThreadComputer.prototype.computeSegment = function (thread) {
        ...
        if (thread.length === 0) {
            ...
            var HISTORY_SIZE = Math.min(thread.length, 20);
            var prevousPegs = thread.slice(-HISTORY_SIZE);
    ...
    ThreadComputer.prototype.computeBestNextPeg = function (currentPeg, pegsToAvoid) {
        var candidates = [];
        var bestScore = MIN_SAFE_NUMBER;
        for (var _i = 0, _a = this.pegs; _i < _a.length; _i++) {
            var peg = _a[_i];
