...
function plot(threadComputer, plotter, nbSegmentsToIgnore) {
    if (nbSegmentsToIgnore >= threadComputer.nbSegments) {
        return;
    }
    var drawFromScratch = (nbSegmentsToIgnore === 0);
    if (drawFromScratch) {
        var plotterInfos = {
...
function main() {
    ...
    parameters_1.Parameters.addRedrawObserver(function () { return nbSegmentsToIgnore = 0; });
    parameters_1.Parameters.addResetObserver(function () { return needToReset = true; });
    var nbSegmentsToIgnore = 0;
    ...
    function mainLoop() {
        if (threadComputer !== null) {
            ...
            var computedSomething = threadComputer.computeNextSegments(20);
